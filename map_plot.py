...
df1 = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/home/jay/Documents/NYCTaxi/trip/trip_data_1.csv')
df1 = sqlContext.read.load('/home/jay/Documents/NYCTaxi/trip/trip_data_1.csv',                          format='com.databricks.spark.csv',
                          header='false',
                          inferSchema='true')

 
'''
df2 = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/home/jay/Documents/NYCTaxi/trip/trip_data_2.csv')
df2 = sqlContext.read.load('/home/jay/Documents/NYCTaxi/trip/trip_data_2.csv',                          format='com.databricks.spark.csv',
                          header='false',
                          inferSchema='true')
 
                          
df3 = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/home/jay/Documents/NYCTaxi/trip/trip_data_8.csv')
df3 = sqlContext.read.load('/home/jay/Documents/NYCTaxi/trip/trip_data_8.csv',                          format='com.databricks.spark.csv',
                          header='false',
                          inferSchema='true')                       


df4 = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/home/jay/Documents/NYCTaxi/trip/trip_data_9.csv')
df4 = sqlContext.read.load('/home/jay/Documents/NYCTaxi/trip/trip_data_9.csv',                          format='com.databricks.spark.csv',
                          header='false',
                          inferSchema='true')
                        
df5 = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/home/jay/Documents/NYCTaxi/trip/trip_data_10.csv')
df5 = sqlContext.read.load('/home/jay/Documents/NYCTaxi/trip/trip_data_10.csv',                          format='com.databricks.spark.csv',
                          header='false',
                          inferSchema='true')  
                          
df6 = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/home/jay/Documents/NYCTaxi/trip/trip_data_11.csv')
df6 = sqlContext.read.load('/home/jay/Documents/NYCTaxi/trip/trip_data_11.csv',                          format='com.databricks.spark.csv',
                          header='false',
                          inferSchema='true')  
                         
df7 = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/home/jay/Documents/NYCTaxi/trip/trip_data_12.csv')
df7 = sqlContext.read.load('/home/jay/Documents/NYCTaxi/trip/trip_data_12.csv',                          format='com.databricks.spark.csv',
                          header='false',
                          inferSchema='true')                                                        
...
Taxi=sqlContext.sql("SELECT pickup_longitude,pickup_latitude, dropoff_longitude, dropoff_latitude from Temp").rdd

Taxi_loc_temp = sqlContext.createDataFrame(Taxi, ["long","lat","drp_long","drp_lat"])




Taxi_loc_temp.registerTempTable("TaxiLocationTemp")

#Taxi_loc =sqlContext.sql("SELECT * from TaxiLocationTemp where long ='null' OR lat ='null' OR drp_long ='null' OR drp_lat ='null'").show(720)
Taxi_loc = [StructField(field_name, StringType(), True) for field_name in Taxi_loc_temp.first()]
Taxi_loc[0].dataType = FloatType()
Taxi_loc[1].dataType = FloatType()
Taxi_loc[2].dataType = FloatType()
Taxi_loc[3].dataType = FloatType()

Taxi_loc_temp.registerTempTable("TaxiLocation")

Taxi_loc = Taxi_loc_temp.dropna()
...
latlong = sqlContext.sql("SELECT long, lat,drp_long, drp_lat FROM TaxiLocation").toPandas()

latlong[['long','lat','drp_long', 'drp_lat']] = latlong[['long','lat','drp_long', 'drp_lat']].astype(float)
...
if __name__ == "__main__":
	...
	#========================================================================================
	mymap = pygmaps(40.7128, -74.0059, 14)
