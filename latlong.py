...
df1 = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/home/jay/Documents/trip/trip_data_1.csv')
...
df2 = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/home/jay/Documents/trip/trip_data_2.csv')
df2 = sqlContext.read.load('/home/jay/Documents/NYCTaxi/trip/trip_data_2.csv',                          format='com.databricks.spark.csv',
                          header='false',
                          inferSchema='true')
 
                          
df3 = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/home/jay/Documents/trip/trip_data_3.csv')
df3 = sqlContext.read.load('/home/jay/Documents/NYCTaxi/trip/trip_data_8.csv',                          format='com.databricks.spark.csv',
                          header='false',
                          inferSchema='true')                       


df4 = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/home/jay/Documents/trip/trip_data_4.csv')
df4 = sqlContext.read.load('/home/jay/Documents/NYCTaxi/trip/trip_data_9.csv',                          format='com.databricks.spark.csv',
                          header='false',
                          inferSchema='true')
                        
df5 = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/home/jay/Documents/trip/trip_data_5.csv')
...
df = unionAll(df1, df2, df3, df4, df5)
